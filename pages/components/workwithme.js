        ...
        <Row className="mt-5">
          <Col md={6} sm={12}>
            ...
            <p className={`${styles.another}`}>
              Get in touch with me if you have any queries and I’ll get back to
              you as soon as possible.
            </p>
            <h5 className={`${styles.another_email}`}>
              <span className={`${styles.border_bottom}`}>umang@gmail.com</span>
            </h5>
          </Col>
          <Col md={6} sm={12}>
            <form
            ...
            >
              <Row className="px-5 pb-0">
                <Col className={`${styles.inFormColumn} p-0`} sm={12}>
                  Name
                </Col>
